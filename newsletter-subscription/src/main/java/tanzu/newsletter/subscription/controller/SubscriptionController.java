...
public class SubscriptionController {
	...
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "Subscription profiles retrieved successfully.", content = @Content(schema = @Schema(implementation = Subscription.class), mediaType = "application/json"), headers = {
					@Header(name = "id", description = "A ascending uniq Id beginning from 1. This Id can be used to identify a record.", required = true, schema = @Schema(type = "integer")),
					@Header(name = "first_name", description = "First Name of the user requesting a newsletter subscriptions", required = false, schema = @Schema(type = "string")),
					@Header(name = "last_name", description = "Last Name of the user requesting a newsletter subscriptions.", required = false, schema = @Schema(type = "string")),
					@Header(name = "email_id", description = "Email address of tssdhe user requesting a newsletter subscriptions.", required = false, schema = @Schema(type = "string"))
			}),
			@ApiResponse(responseCode = "404", description = "No ubscription profiles found.", content = @Content(schema = @Schema(implementation = Subscription.class),
	...
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "User's test subscription profile successfully saved.", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Subscription.class)), mediaType = "application/json", examples = {
					@ExampleObject(name = "createSubscriptionArray", summary = "Add array of subscription profiles.", description = "Submitts an array of Newsletter subscription profiles.", value = "[{ \"emailId\":\"john@example.com\", \"firstName\":\"John\", \"lastName\":\"Fogerty\"}, {      		\"emailId\":\"frank@example.com\", \"firstName\":\"Frank\", \"lastName\":\"Zappa\"}, {\"emailId\":\"bob@example.com\", \"firstName\":\"Bob\", \"lastName\":\"Seger\"}]"

					),
					@ExampleObject(name = "createSubscription", summary = "Add subscription profile.", description = "RSubmitts a Newsletter subscription profils.", value = "[{ \"emailId\":\"frank@example.com\", \"firstName\":\"Frank\", \"lastName\":\"Zappa\"}]")
			}), headers = {
					@Header(name = "id", description = "A ascending uniq Id beginning from 1. This Id can be used to identify a record.", required = true, schema = @Schema(type = "integer")),
					@Header(name = "first_name", description = "First Name of the user requesting a newsletter subscriptions", required = false, schema = @Schema(type = "string")),
					@Header(name = "last_name", description = "Last Name of the user requesting a newsletter subscriptions.", required = false, schema = @Schema(type = "string")),
					@Header(name = "email_id", description = "Email address of the user requesting a newsletter subscriptions.", required = false, schema = @Schema(type = "string"))
			}),
			@ApiResponse(responseCode = "409", description = "Passed Email address is already registerd.", content = @Content(schema = @Schema(implementation = Subscription.class),
					// examples = {@ExampleObject(name = "getAllSubscription", summary = "Retrieves all user subscription registered.",
					examples = {
							@ExampleObject(value = "{ \"timestamp\":\"2023-04-13T19:42:38.918+00:00\", \"status\":\"409\", \"error\":\"Conflict\", \"path\":\"/api/v1/subscription\" }") }, mediaType = "application/json")),
	...
	@ApiResponses({
			@ApiResponse(responseCode = "302", description = "User's subscription profile succesfound by its Id.", content = @Content(schema = @Schema(implementation = Subscription.class), mediaType = "application/json"), headers = {
					@Header(name = "id", description = "A ascending uniq Id beginning from 1. This Id can be used to identify a record.", required = true, schema = @Schema(type = "integer")),
					@Header(name = "first_name", description = "First Name of the user requesting a newsletter subscriptions", required = false, schema = @Schema(type = "string")),
					@Header(name = "last_name", description = "Last Name of the user requesting a newsletter subscriptions.", required = false, schema = @Schema(type = "string")),
					@Header(name = "email_id", description = "Email address of the user requesting a newsletter subscriptions.", required = false, schema = @Schema(type = "string"))
			}),
			@ApiResponse(responseCode = "404", description = "Subscription with the provided id not found.", content = @Content(schema = @Schema(implementation = Exception.class), mediaType = "application/json"))
	})
	...
	@ApiResponses({
			...
			@ApiResponse(responseCode = "404", description = "ubscription with the provided id not found.", content = @Content(schema = @Schema(implementation = Subscription.class),
					// examples = {@ExampleObject(name = "getAllSubscription", summary = "Retrieves all user subscription registered.",
					examples = {
							@ExampleObject(value = "{ \"timestamp\":\"2023-04-13T19:42:38.918+00:00\", \"status\":\"404\", \"error\":\"Conflict\", \"path\":\"/api/v1/subscription\" }") }, mediaType = "application/json"))
	})
	...
	@ApiResponses({
			@ApiResponse(responseCode = "201", description = "Ssubscription profile successfully deleted.", content = @Content(schema = @Schema(implementation = Subscription.class), examples = {
					@ExampleObject(name = "getUserAttribute", summary = "Delete a subscription profile.", description = "Delete a user's subscription profile with the provided subscription id.", value = "{ \"deleted\":\"true\" }") }, mediaType = "application/json")),
			@ApiResponse(responseCode = "404", description = "Subscription profile not found.", content = @Content(schema = @Schema(implementation = Subscription.class), examples = {
					@ExampleObject(name = "getAllSubscription", summary = "Retrieves all user subscription registered.", description = "Retrieves a User's attributes.", value = "{ \"timestamp\":\"2023-04-13T19:42:38.918+00:00\", \"status\":\"404\", \"error\":\"Conflict\", \"path\":\"/api/v1/subscription\" }") }, mediaType = "application/json"))
	})
