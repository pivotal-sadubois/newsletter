...
*/
	...
	@ApiResponses({
		...
		@ApiResponse(
			...
			examples = {
				@ExampleObject(value = "{ \"timestamp\":\"2023-04-13T19:42:38.918+00:00\", \"status\":\"409\", \"error\":\"Conflict\", \"path\":\"/api/v1/subscription\" }")
			},
			mediaType = "application/json")
		),
		@ApiResponse(
			...
			content = @Content(schema = @Schema(implementation = Subscription.class),
			examples = {
				@ExampleObject(value = "{ \"timestamp\":\"2023-04-13T19:42:38.918+00:00\", \"status\":\"404\", \"error\":\"Bad Request\", \"path\":\"/api/v1/subscription\" }")
			},
			mediaType = "application/json")
		)
    })
	...
	public ResponseEntity<Subscription> getSubscriptionById(@PathVariable Long id) {
		Subscription subscription = subscriptionRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Subscription with id: " + id + "does not exist."));
