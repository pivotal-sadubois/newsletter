...
public class SubscriptionController {
	...
	public List<Subscription> getAllSubscription() {
		System.out.println("HTTP-GET: /api/subscriptions");
	...
	*/
	...
	System.out.println("subscription{}");System.out.println("    - Element: "+subscription.getEmailId());System.out.println("    - Element: "+subscription.getFirstName());System.out.println("    - Element: "+subscription.getLastName());System.out.println("    - Element: "+subscription.getId());
	...
	@ApiResponses({
		@ApiResponse(
			...
			content = @Content(array = @ArraySchema(schema = @Schema(implementation = Subscription.class)), mediaType = "application/json",	
						examples = {@ExampleObject(
		...
		@ApiResponse(
			...
			content = @Content(schema = @Schema(implementation = Subscription.class),
				// examples = {@ExampleObject(name = "getAllSubscription", summary = "Retrieves all user subscription registered.",
				examples = {@ExampleObject(
					value="{ \"timestamp\":\"2023-04-13T19:42:38.918+00:00\", \"status\":\"409\", \"error\":\"Conflict\", \"path\":\"/api/v1/subscription\" }")}, 
					mediaType="application/json"
			)
		),
		@ApiResponse(
